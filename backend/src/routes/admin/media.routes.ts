import{Router}from"express";import{upload}from"../../middlewares/upload.middleware.js";import{Media}from"../../models/Media.js";import{ok,created}from"../../utils/response.js";import{audit}from"../../services/auditLog.service.js";import{uploadBlob,replaceBlob,deleteBlob}from"../../services/azureBlob.service.js";import{AppError}from"../../middlewares/error.middleware.js";

const r=Router();

r.get("/",async(req,res)=>ok(res,await Media.find().sort({createdAt:-1})));
...
const handleUpload=async(req:any,res:any,next:any)=>{
  try{
    ...
    const bucket=String(req.params.bucket||"media").replace(/[^a-z0-9-]/gi,"");
